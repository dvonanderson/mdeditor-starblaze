...
DocToc works great with git hooks! You could add it to:

### Pre-commit Hook

Automatically update TOC before commits:

```bash
# .husky/pre-commit
npx doctoc README.md QUICK_START.md
git add README.md QUICK_START.md
```

### Manual Updates (Current Approach)

We currently run doctoc manually to have more control over when TOC is updated.
...
DocToc generates anchor links automatically. If you need custom anchors, you may need to use HTML anchors in your Markdown.
