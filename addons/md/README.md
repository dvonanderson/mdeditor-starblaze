# Md - Style & Component Ember Addon for MdEditor
...
`"md": "workspace:*"`, for applications included in this monorepo. Application's
may then import md styles by adding `@use 'md';` to their stylesheets.
...
`ember g component md/component-name`.
