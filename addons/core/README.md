# Core Features Addon for MdEditor

This addon contains core features used by MdEditor UIs, such as i18n and
helpers.
...
(see mdeditor for example).

## Loading Helper

See MdEditor routes and templates for examples of how to
